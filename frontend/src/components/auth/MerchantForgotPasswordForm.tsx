...
const BG_ICONS: Array<{
  ...
  { key: 'b1', IconComponent: HiShoppingCart, top: '0%', left: '0%', color: 'text-gray-700', opacity: 0.22, rotate: -12 },
  { key: 'b2', IconComponent: HiTruck, top: '0%', left: '12%', color: 'text-gray-600', opacity: 0.20, rotate: 10 },
  { key: 'b3', IconComponent: HiCreditCard, top: '0%', left: '24%', color: 'text-gray-800', opacity: 0.22, rotate: -8 },
  { key: 'b4', IconComponent: HiShoppingBag, top: '0%', left: '36%', color: 'text-gray-700', opacity: 0.20, rotate: 14 },
  { key: 'b5', IconComponent: FaWallet, top: '0%', left: '48%', color: 'text-gray-600', opacity: 0.22, rotate: -10 },
  { key: 'b6', IconComponent: HiCube, top: '0%', left: '60%', color: 'text-gray-800', opacity: 0.20, rotate: 8 },
  { key: 'b7', IconComponent: FaMoneyBillWave, top: '0%', left: '72%', color: 'text-gray-700', opacity: 0.22, rotate: -6 },
  { key: 'b8', IconComponent: HiCash, top: '0%', left: '84%', color: 'text-gray-600', opacity: 0.20, rotate: 12 },
  { key: 'b9', IconComponent: HiTag, top: '12%', left: '6%', color: 'text-gray-800', opacity: 0.22, rotate: 10 },
  { key: 'b10', IconComponent: HiGift, top: '12%', left: '18%', color: 'text-gray-700', opacity: 0.20, rotate: -8 },
  { key: 'b11', IconComponent: HiReceiptTax, top: '12%', left: '30%', color: 'text-gray-600', opacity: 0.22, rotate: 12 },
  { key: 'b12', IconComponent: FaBoxOpen, top: '12%', left: '42%', color: 'text-gray-800', opacity: 0.20, rotate: -14 },
  { key: 'b13', IconComponent: HiCurrencyDollar, top: '12%', left: '54%', color: 'text-gray-700', opacity: 0.22, rotate: 8 },
  { key: 'b14', IconComponent: HiShoppingCart, top: '12%', left: '66%', color: 'text-gray-600', opacity: 0.20, rotate: -10 },
  { key: 'b15', IconComponent: HiTruck, top: '12%', left: '78%', color: 'text-gray-800', opacity: 0.22, rotate: 14 },
  { key: 'b16', IconComponent: HiCreditCard, top: '12%', left: '90%', color: 'text-gray-700', opacity: 0.20, rotate: -6 },
  { key: 'b17', IconComponent: HiCube, top: '25%', left: '0%', color: 'text-gray-600', opacity: 0.22, rotate: 10 },
  { key: 'b18', IconComponent: FaWallet, top: '25%', left: '15%', color: 'text-gray-800', opacity: 0.20, rotate: -12 },
  { key: 'b19', IconComponent: HiTag, top: '25%', left: '30%', color: 'text-gray-700', opacity: 0.22, rotate: 8 },
  { key: 'b20', IconComponent: HiCash, top: '25%', left: '48%', color: 'text-gray-600', opacity: 0.20, rotate: -10 },
  { key: 'b21', IconComponent: HiShoppingBag, top: '25%', left: '63%', color: 'text-gray-800', opacity: 0.22, rotate: 12 },
  { key: 'b22', IconComponent: FaMoneyBillWave, top: '25%', left: '78%', color: 'text-gray-700', opacity: 0.20, rotate: -8 },
  { key: 'b23', IconComponent: HiReceiptTax, top: '25%', left: '93%', color: 'text-gray-600', opacity: 0.22, rotate: 10 },
  { key: 'b24', IconComponent: HiGift, top: '38%', left: '6%', color: 'text-gray-700', opacity: 0.20, rotate: -14 },
  { key: 'b25', IconComponent: FaBoxOpen, top: '38%', left: '21%', color: 'text-gray-800', opacity: 0.22, rotate: 10 },
  { key: 'b26', IconComponent: HiCurrencyDollar, top: '38%', left: '36%', color: 'text-gray-600', opacity: 0.20, rotate: -8 },
  { key: 'b27', IconComponent: HiShoppingCart, top: '38%', left: '51%', color: 'text-gray-800', opacity: 0.22, rotate: 12 },
  { key: 'b28', IconComponent: HiTruck, top: '38%', left: '66%', color: 'text-gray-700', opacity: 0.20, rotate: -12 },
  { key: 'b29', IconComponent: HiCreditCard, top: '38%', left: '81%', color: 'text-gray-600', opacity: 0.22, rotate: 8 },
  { key: 'b30', IconComponent: HiCube, top: '50%', left: '0%', color: 'text-gray-700', opacity: 0.20, rotate: -10 },
  { key: 'b31', IconComponent: FaWallet, top: '50%', left: '18%', color: 'text-gray-800', opacity: 0.22, rotate: 14 },
  { key: 'b32', IconComponent: HiTag, top: '50%', left: '36%', color: 'text-gray-600', opacity: 0.20, rotate: -6 },
  { key: 'b33', IconComponent: HiCash, top: '50%', left: '54%', color: 'text-gray-800', opacity: 0.22, rotate: 10 },
  { key: 'b34', IconComponent: HiShoppingBag, top: '50%', left: '72%', color: 'text-gray-700', opacity: 0.20, rotate: -12 },
  { key: 'b35', IconComponent: FaMoneyBillWave, top: '50%', left: '90%', color: 'text-gray-600', opacity: 0.22, rotate: 8 },
  { key: 'b36', IconComponent: HiShoppingCart, top: '62%', left: '6%', color: 'text-gray-800', opacity: 0.20, rotate: -8 },
  { key: 'b37', IconComponent: HiReceiptTax, top: '62%', left: '24%', color: 'text-gray-700', opacity: 0.22, rotate: 12 },
  { key: 'b38', IconComponent: FaBoxOpen, top: '62%', left: '42%', color: 'text-gray-600', opacity: 0.20, rotate: -14 },
  { key: 'b39', IconComponent: HiCurrencyDollar, top: '62%', left: '60%', color: 'text-gray-800', opacity: 0.22, rotate: 8 },
  { key: 'b40', IconComponent: HiGift, top: '62%', left: '78%', color: 'text-gray-700', opacity: 0.20, rotate: -10 },
  { key: 'b41', IconComponent: HiTruck, top: '75%', left: '0%', color: 'text-gray-600', opacity: 0.22, rotate: 10 },
  { key: 'b42', IconComponent: HiCreditCard, top: '75%', left: '15%', color: 'text-gray-800', opacity: 0.20, rotate: -8 },
  { key: 'b43', IconComponent: HiCube, top: '75%', left: '30%', color: 'text-gray-700', opacity: 0.22, rotate: 14 },
  { key: 'b44', IconComponent: FaWallet, top: '75%', left: '45%', color: 'text-gray-600', opacity: 0.20, rotate: -12 },
  { key: 'b45', IconComponent: HiTag, top: '75%', left: '60%', color: 'text-gray-800', opacity: 0.22, rotate: 8 },
  { key: 'b46', IconComponent: HiCash, top: '75%', left: '78%', color: 'text-gray-700', opacity: 0.20, rotate: -10 },
  { key: 'b47', IconComponent: HiShoppingCart, top: '88%', left: '6%', color: 'text-gray-600', opacity: 0.22, rotate: 12 },
  { key: 'b48', IconComponent: FaMoneyBillWave, top: '88%', left: '24%', color: 'text-gray-800', opacity: 0.20, rotate: -8 },
  { key: 'b49', IconComponent: HiShoppingBag, top: '88%', left: '42%', color: 'text-gray-700', opacity: 0.22, rotate: 10 },
  { key: 'b50', IconComponent: FaBoxOpen, top: '88%', left: '60%', color: 'text-gray-600', opacity: 0.20, rotate: -14 },
  { key: 'b51', IconComponent: HiReceiptTax, top: '88%', left: '78%', color: 'text-gray-800', opacity: 0.22, rotate: 8 },
  { key: 'b52', IconComponent: HiCurrencyDollar, top: '88%', left: '93%', color: 'text-gray-700', opacity: 0.20, rotate: -10 },
]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 relative overflow-hidden flex flex-col items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-white/10 rounded-3xl transform -rotate-45 -translate-x-48 -translate-y-48" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-white/10 rounded-3xl transform rotate-45 translate-x-48 translate-y-48" />
        <div className="absolute top-1/4 -right-20 w-80 h-80 bg-white/8 rounded-3xl transform rotate-12" />
        <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-white/8 rounded-3xl transform -rotate-12" />
        <div className="absolute top-10 -left-32 w-72 h-72 bg-white/9 rounded-3xl transform rotate-25" />
        <div className="absolute bottom-10 -right-32 w-72 h-72 bg-white/9 rounded-3xl transform -rotate-25" />

        {BG_ICONS.map(({ key, IconComponent, top, left, color, opacity, rotate }) => (
          <div key={key} className={bgIconWrapperClass} style={{ top, left }}>
            <IconComponent
